...
function downloadMARC(record,institution_info) {
	...
	var text = timestamp_directory + controlfield006_directory + controlfield007_directory + controlfield008_directory + isbn[0] + default1_directory + subject_catagories[0] + author[0] + corporate_author[0] + title[0] + edition[0] + pub[0] + copyright[0] + physical[0] + default2_directory + default3_directory + default4_directory + notes[0] + subjects[0] + keywords[0] + fast[0] + additional_authors[0] + additional_corporate_authors[0] + web_url[0] + title880[0] + edition880[0] + publisher880[0] + author880[0] + corporate880[0] + authors880[0] + corporations880[0] + timestamp_content + controlfield006_content + controlfield007_content + controlfield008_content + isbn[1] + default1_content + subject_catagories[1] + author[1] + corporate_author[1] + title[1] + edition[1] + pub[1] + copyright[1] + physical[1] + default2_content + default3_content + default4_content + notes[1] + subjects[1] + keywords[1] + fast[1] + additional_authors[1] + additional_corporate_authors[1] + web_url[1] + title880[1] + edition880[1] + publisher880[1] + author880[1] + corporate880[1] + authors880[1] + corporations880[1] + end;
