...
function downloadMODS(record,institution_info) {
	...
	var text = startText + titleText + authorText + corporateText + defaultText1 + isbnText + urlText + originText + languageText + pagesText + defaultText2 + keywordsText + subjectsText + fastText + literatureText + defaultText3 + endText;
